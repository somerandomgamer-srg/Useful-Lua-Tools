...
print("- math.fib(10) (now efficient!):", math.fib(10))
print("- math.fib(30):", math.fib(30))
print("- XOR 'hello' with 'key':", cryptography.xor("hello", "key"))
print("- XOR result back:", cryptography.xor(cryptography.xor("hello", "key"), "key"))

print("\n✅ Library ready! Now using native Lua " .. _VERSION .. " bitwise operators (&, |, <<, >>).")
print("📋 All functions fixed and optimized!")